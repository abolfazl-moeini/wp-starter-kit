...
$GLOBALS['wpdev_wp_actions'] = [];
$GLOBALS['wpdev_wp_actions_fired'] = [];
$GLOBALS['wpdev_wp_current_filter'] = '';
$GLOBALS['wpdev_wp_rest_routes'] = [];
$GLOBALS['wpdev_wp_shortcodes'] = [];
$GLOBALS['wpdev_wp_transients'] = [];
$GLOBALS['wpdev_wp_current_user_caps'] = ['read' => true];

if (!function_exists('wpdev_test_reset_wp_state')) {
    function wpdev_test_reset_wp_state(): void
    {
        $GLOBALS['wpdev_wp_actions'] = [];
        $GLOBALS['wpdev_wp_actions_fired'] = [];
        $GLOBALS['wpdev_wp_current_filter'] = '';
...
if (!function_exists('add_action')) {
    ...
    {
        $GLOBALS['wpdev_wp_actions'][$hook][(int) $priority][] = $callback;
    }
}
...
if (!function_exists('do_action')) {
    ...
    {
        $GLOBALS['wpdev_wp_actions_fired'][] = $hook;
        $GLOBALS['wpdev_wp_current_filter'] = $hook;
        $callbacks = $GLOBALS['wpdev_wp_actions'][$hook] ?? [];
        ksort($callbacks);
...
if (!function_exists('did_action')) {
    ...
    {
        return in_array($hook, $GLOBALS['wpdev_wp_actions_fired'], true);
    }
}
if (!function_exists('has_action')) {
    function has_action($hook, $callback = null)
    {
        if (!isset($GLOBALS['wpdev_wp_actions'][$hook])) {
            return false;
        }
        if ($callback === null) {
            return true;
        }
        foreach ($GLOBALS['wpdev_wp_actions'][$hook] as $priorityCallbacks) {
...
if (!function_exists('remove_action')) {
    ...
    function remove_action($hook, $callback, $priority = null)
    {
        ...
        if ($priority === null) {
            foreach ($GLOBALS['wpdev_wp_actions'][$hook] as $prio => $cbs) {
                $GLOBALS['wpdev_wp_actions'][$hook][$prio] = array_values(
                    array_filter($cbs, static fn($c) => $c !== $callback)
                );
                if (empty($GLOBALS['wpdev_wp_actions'][$hook][$prio])) {
                    unset($GLOBALS['wpdev_wp_actions'][$hook][$prio]);
                }
            }
            return;
        }
        if (!isset($GLOBALS['wpdev_wp_actions'][$hook][(int) $priority])) {
            return;
        }
        $GLOBALS['wpdev_wp_actions'][$hook][(int) $priority] = array_values(
            array_filter(
                $GLOBALS['wpdev_wp_actions'][$hook][(int) $priority],
                static fn($c) => $c !== $callback
            )
        );
        if (empty($GLOBALS['wpdev_wp_actions'][$hook][(int) $priority])) {
            unset($GLOBALS['wpdev_wp_actions'][$hook][(int) $priority]);
        }
    }
}
if (!function_exists('current_filter')) {
    ...
    {
        return $GLOBALS['wpdev_wp_current_filter'] ?? '';
    }
}
if (!function_exists('wp_enqueue_script')) {
    function wp_enqueue_script(...$args) {
        if (isset($GLOBALS['wpdev_test_wp_calls'])) {
            $GLOBALS['wpdev_test_wp_calls'][] = ['fn' => 'wp_enqueue_script', 'args' => $args];
        }
    }
}
if (!function_exists('wp_register_script')) {
    function wp_register_script(...$args) {
        if (isset($GLOBALS['wpdev_test_wp_calls'])) {
            $GLOBALS['wpdev_test_wp_calls'][] = ['fn' => 'wp_register_script', 'args' => $args];
        }
    }
}
if (!function_exists('wp_register_style')) {
    function wp_register_style(...$args) {
        if (isset($GLOBALS['wpdev_test_wp_calls'])) {
            $GLOBALS['wpdev_test_wp_calls'][] = ['fn' => 'wp_register_style', 'args' => $args];
        }
    }
}
if (!function_exists('wp_enqueue_style')) {
    function wp_enqueue_style(...$args) {
        if (isset($GLOBALS['wpdev_test_wp_calls'])) {
            $GLOBALS['wpdev_test_wp_calls'][] = ['fn' => 'wp_enqueue_style', 'args' => $args];
        }
    }
}
...
if (!function_exists('wp_localize_script')) {
    function wp_localize_script(...$args) {
        if (isset($GLOBALS['wpdev_test_wp_calls'])) {
            $GLOBALS['wpdev_test_wp_calls'][] = ['fn' => 'wp_localize_script', 'args' => $args];
        }
    }
}
...
if (!function_exists('plugin_dir_path')) {
    ...
    function plugin_dir_path($file) {
        // Test override: when a test sets $GLOBALS['wpdev_test_plugin_dir'],
        ...
        if (!empty($GLOBALS['wpdev_test_plugin_dir'])) {
            return rtrim((string) $GLOBALS['wpdev_test_plugin_dir'], '/\\') . '/';
        }
...
if (!function_exists('add_shortcode')) {
    ...
    {
        $GLOBALS['wpdev_wp_shortcodes'][$tag] = $callback;
    }
}
...
if (!function_exists('current_user_can')) {
    ...
    {
        return !empty($GLOBALS['wpdev_wp_current_user_caps'][$capability]);
    }
}
if (!function_exists('get_transient')) {
    function get_transient($key)
    {
        return $GLOBALS['wpdev_wp_transients'][$key] ?? false;
    }
}
if (!function_exists('set_transient')) {
    function set_transient($key, $value, $expiration = 0)
    {
        $GLOBALS['wpdev_wp_transients'][$key] = $value;
        return true;
    }
}
if (!function_exists('delete_transient')) {
    ...
    {
        unset($GLOBALS['wpdev_wp_transients'][$key]);
        return true;
    }
}
...
if (!function_exists('is_admin')) {
    function is_admin()
    {
        return !empty($GLOBALS['wpdev_test_is_admin']);
    }
}
