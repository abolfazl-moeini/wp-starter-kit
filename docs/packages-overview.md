...
| WPDev bridge       | `@wpdev/wpdev-bridge`                         | WPDev AJAX / localize / hooks adapters for Polaris module entries     | yes         | `index.js`                   | [packages/wpdev-bridge/README.md](../packages/wpdev-bridge/README.md)                  |
