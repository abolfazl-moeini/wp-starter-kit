...
`0.4.0`, `1.0.0` (framework-as-dependency), through **`2.6.0`**
(pre-dist release test gate — see [scaffold.md](scaffold.md) § Release packaging;
`2.5.0` was the `e2eTest` feature backfill — see [e2e-tests.md](e2e-tests.md)).
