<?php
/**
 * Rector build pipeline — downgrades PHP to phpMinVersion (from wpdev.json)
 * for distribution / compatibility checks.
 *
 ...
 * Also invoked by `release:dist` against `dist/{slug}/` (before stripping `dev/`).
 */
