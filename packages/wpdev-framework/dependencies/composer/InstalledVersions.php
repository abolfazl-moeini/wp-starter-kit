 ...
 */
namespace WPDev\Dependencies\Composer;

use WPDev\Dependencies\Composer\Autoload\ClassLoader;
use WPDev\Dependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WPDev\\Dependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
