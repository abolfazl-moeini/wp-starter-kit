...
<li class="<?php echo esc_attr(trim($field->wrapper_classes)); ?>" <?php echo $field->get_wrapper_html_attributes(); ?>>
  ...
  <div class="wpdev-block wpdev-w-full">
    ...
    <select class="wpdev_select_icon" name="<?php echo esc_attr($field->id); ?>">

        <option value=""><?php echo __('No Icon','wpdev'); ?></option>

        <?php foreach (wpdev_get_icons_list() as $category_label => $category_array) : ?>
