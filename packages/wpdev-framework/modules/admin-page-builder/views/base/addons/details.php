...
<style type="text/css">
    ...
    #plugin-information-title.with-banner {
      ...
      background-image: url("<?php echo esc_url( $addon->image_url ); ?>");
    }
    ...
    <div id="plugin-information-scrollable">
        ...
        <div id="plugin-information-tabs" class="with-banner">
            ...
            <a name="changelog" href="#">
              ...
              <?php _e('Changelog', 'wpdev'); ?>

            </a>

            <a name="screenshots" href="#">

              <?php _e('Screenshots', 'wpdev'); ?>

            </a>

            <a name="reviews" href="#">

              <?php _e('Reviews', 'wpdev'); ?>
        ...
        <div id="plugin-information-content" class="with-banner">
            ...
            <div class="fyi">
                ...
                <ul>
                    <li>
                        <strong><?php _e('Author:', 'wpdev'); ?></strong>
                        <a class="wpdev-no-underline" href="<?php echo esc_url( $addon->author_url ); ?>" target="_blank">
                    ...
                    <?php if (isset($addon->requires_version)) : ?>
                        ...
                        <li>
                            <strong><?php _e('Requires WPDev Version:', 'wpdev'); ?></strong>
						<?php echo esc_html( sprintf( __( '%s or higher', 'wpdev' ), $addon->requires_version ) ); ?>
                        </li>

                    <?php endif; ?>

                    <li>
                      <a class="wpdev-no-underline" target="_blank" href="https://wpdev.ir/addons?addon=<?php echo esc_attr( $addon_slug ); ?>">
                        <?php _e('See on the Oficial Site »', 'wpdev'); ?>
                      </a>
                    </li>
...
<!--
    ...
    <div id="plugin-information-footer">
      ...
      <?php if (!$addon->free) : ?>
        ...
        <span class="wpdev-text-green-800 wpdev-inline-block wpdev-py-1">

			<?php _e('This is a Premium Add-on.', 'wpdev'); ?>

        </span>

      <?php endif; ?>

      <form id="plugin-install" class="wpdev_form">
        ...
        <?php if ($addon->installed) : ?>
          ...
          >
			<?php _e('Already Installed', 'wpdev'); ?>
          </button>
        ...
        <?php else : ?>
            ...
            <?php if ($addon->available) : ?>
                ...
                <?php if ($license->allowed('wpdev') || $addon->free) : ?>
            ...
            <?php else : ?>
                ...
                class="button button-primary right"
                >
                <?php _e('Upgrade your License', 'wpdev'); ?>
                </a>
          ...
          <input type="hidden" name="action" value="wpdev_form_handler">

          <input type="hidden" name="addon" value="<?php echo esc_attr( $addon_slug ); ?>">

          <input type="hidden" name="wpdev-when" value="<?php echo esc_attr( base64_encode('after_setup_theme') ); ?>">

			<?php wp_nonce_field('wpdev_form_addon_more_info'); ?>
