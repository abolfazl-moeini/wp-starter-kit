<?php
/**
 * WPDev Customize/Add New Template Previewer Page.
 *
 * @package WPDev
...
/**
 * WPDev Template Previewer Customize/Add New Admin Page.
 */
abstract class Customizer_Admin_Page extends Edit_Admin_Page {
	...
	public function page_loaded() {
		...
		add_action("wpdev_edit_{$screen->id}_after_normal", array($this, 'display_preview_window'));
	...
	public function display_preview_window() {
		...
		wpdev_get_template('base/edit/editor-customizer', array(
	...
	public function register_scripts() {
		...
		wp_enqueue_script('wpdev-customizer', wpdev_get_module_asset_url('admin-page-builder', 'customizer.js', 'js'), array('jquery', 'wpdev-vue', 'wpdev-block-ui'));
