...
(function($) {
  ...
  window.addEventListener('message', function(message) {
    ...
    if (message.data === 'wpdev_preview_changed') {

      block = wpdev_block_ui('#preview_content');
  ...
  $(document).ready(function() {
    ...
    const wpdev_preview_stage = new Vue({
      el: '#preview-stage',
      data() {
    ...
    $('[data-wpdev-customizer-panel]').each(function() {

      const app = $(this);

      const app_name = 'wpdev_' + app.data('wpdev-app');

      wp.hooks.addAction(app_name + '_changed', 'wpdev', function(prop) {
