...
namespace WPDev\Dependencies\Amp;

use WPDev\Dependencies\React\Promise\PromiseInterface as ReactPromise;
/**
...
namespace WPDev\Dependencies\Amp\Promise;

use WPDev\Dependencies\Amp\Deferred;
use WPDev\Dependencies\Amp\Loop;
use WPDev\Dependencies\Amp\MultiReasonException;
use WPDev\Dependencies\Amp\Promise;
use WPDev\Dependencies\Amp\Success;
use WPDev\Dependencies\Amp\TimeoutException;
use WPDev\Dependencies\React\Promise\PromiseInterface as ReactPromise;
use function WPDev\Dependencies\Amp\call;
use function WPDev\Dependencies\Amp\Internal\createTypeError;
/**
...
namespace WPDev\Dependencies\Amp\Iterator;

use WPDev\Dependencies\Amp\Delayed;
use WPDev\Dependencies\Amp\Emitter;
use WPDev\Dependencies\Amp\Iterator;
use WPDev\Dependencies\Amp\Producer;
use WPDev\Dependencies\Amp\Promise;
use function WPDev\Dependencies\Amp\call;
use function WPDev\Dependencies\Amp\coroutine;
use function WPDev\Dependencies\Amp\Internal\createTypeError;
/**
