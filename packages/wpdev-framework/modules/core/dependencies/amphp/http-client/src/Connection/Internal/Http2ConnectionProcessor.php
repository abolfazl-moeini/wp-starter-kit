...
namespace WPDev\Dependencies\Amp\Http\Client\Connection\Internal;

use WPDev\Dependencies\Amp\ByteStream\InMemoryStream;
use WPDev\Dependencies\Amp\ByteStream\IteratorStream;
...
use WPDev\Dependencies\Amp\CombinedCancellationToken;
use WPDev\Dependencies\Amp\Coroutine;
use WPDev\Dependencies\Amp\Deferred;
use WPDev\Dependencies\Amp\Emitter;
use WPDev\Dependencies\Amp\Failure;
use WPDev\Dependencies\Amp\Http\Client\Connection\Http2ConnectionException as ClientHttp2ConnectionException;
use WPDev\Dependencies\Amp\Http\Client\Connection\Http2StreamException as ClientHttp2StreamException;
use WPDev\Dependencies\Amp\Http\Client\Connection\HttpStream;
...
use WPDev\Dependencies\Amp\Http\Client\Internal\ResponseBodyStream;
...
use WPDev\Dependencies\Amp\Http\Client\TimeoutException;
use WPDev\Dependencies\Amp\Http\Client\Trailers;
use WPDev\Dependencies\Amp\Http\HPack;
use WPDev\Dependencies\Amp\Http\Http2\Http2ConnectionException;
use WPDev\Dependencies\Amp\Http\Http2\Http2Parser;
use WPDev\Dependencies\Amp\Http\Http2\Http2Processor;
use WPDev\Dependencies\Amp\Http\Http2\Http2StreamException;
use WPDev\Dependencies\Amp\Http\InvalidHeaderException;
use WPDev\Dependencies\Amp\Http\Status;
use WPDev\Dependencies\Amp\Iterator;
use WPDev\Dependencies\Amp\Loop;
use WPDev\Dependencies\Amp\Promise;
use WPDev\Dependencies\Amp\Socket\EncryptableSocket;
use WPDev\Dependencies\Amp\Success;
use WPDev\Dependencies\Amp\TimeoutCancellationToken;
use WPDev\Dependencies\League\Uri;
use function WPDev\Dependencies\Amp\asyncCall;
use function WPDev\Dependencies\Amp\call;
use function WPDev\Dependencies\Amp\Http\Client\Internal\normalizeRequestPathWithQuery;
/** @internal */
final class Http2ConnectionProcessor implements Http2Processor
{
    ...
    public function handlePushPromise(int $streamId, int $pushId, array $pseudo, array $headers) : void
    {
        ...
        $stream->requestBodyComplete = \true;
        ...
        return call(function () use($request, $cancellationToken, $stream) : \Generator {
            ...
            try {
                ...
                if ($chunk === null) {
                    ...
                    $http2stream->requestBodyComplete = \true;
