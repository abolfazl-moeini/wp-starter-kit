...
use WPDev\Dependencies\Amp\Http\Client\Connection\ConnectionPool;
use WPDev\Dependencies\Amp\Http\Client\Connection\UnlimitedConnectionPool;
use WPDev\Dependencies\Amp\Http\Client\Interceptor\DecompressResponse;
use WPDev\Dependencies\Amp\Http\Client\Interceptor\FollowRedirects;
use WPDev\Dependencies\Amp\Http\Client\Interceptor\ForbidUriUserInfo;
use WPDev\Dependencies\Amp\Http\Client\Interceptor\RetryRequests;
use WPDev\Dependencies\Amp\Http\Client\Interceptor\SetRequestHeaderIfUnset;
