...
use WPDev\Dependencies\Amp\WindowsRegistry\KeyNotFoundException;
use WPDev\Dependencies\Amp\WindowsRegistry\WindowsRegistry;
...
final class WindowsConfigLoader implements ConfigLoader
{
    ...
    public function loadConfig() : Promise
    {
        return call(function () {
            $keys = ["WPDev\\Dependencies\\HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters\\NameServer", "WPDev\\Dependencies\\HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters\\DhcpNameServer"];
            ...
            if ($nameserver === "") {
                $interfaces = "WPDev\\Dependencies\\HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters\\Interfaces";
