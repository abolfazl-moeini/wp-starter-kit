...
namespace WPDev\Dependencies\Amp\Cache;
...
use WPDev\Dependencies\Amp\Sync\KeyedMutex;
...
final class FileCache implements Cache
{
    ...
    public function __construct(string $directory, KeyedMutex $mutex)
    {
        ...
        $this->ampFileVersion2 = $ampFileVersion2 = \function_exists('WPDev\\Dependencies\\Amp\\File\\listFiles');
