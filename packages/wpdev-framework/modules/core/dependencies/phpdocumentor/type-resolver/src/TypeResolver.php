 ...
 */
namespace WPDev\Dependencies\phpDocumentor\Reflection;

use WPDev\Dependencies\Doctrine\Deprecations\Deprecation;
use InvalidArgumentException;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\ArrayShape;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\ArrayShapeItem;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\CallableString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\ConstExpression;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\False_;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\FloatValue;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\HtmlEscapedString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\IntegerRange;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\IntegerValue;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\List_;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\LiteralString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\LowercaseString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\NegativeInteger;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\NonEmptyList;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\NonEmptyLowercaseString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\NonEmptyString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\Numeric_;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\NumericString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\PositiveInteger;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\StringValue;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\TraitString;
use WPDev\Dependencies\phpDocumentor\Reflection\PseudoTypes\True_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\AggregatedType;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Array_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\ArrayKey;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Boolean;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Callable_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\CallableParameter;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\ClassString;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Collection;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Compound;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Context;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Expression;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Float_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Integer;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\InterfaceString;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Intersection;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Iterable_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Mixed_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Never_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Null_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Nullable;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Object_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Parent_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Resource_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Scalar;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Self_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Static_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\String_;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\This;
use WPDev\Dependencies\phpDocumentor\Reflection\Types\Void_;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprFloatNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprIntegerNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprStringNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\ConstExpr\ConstFetchNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ArrayShapeItemNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\CallableTypeParameterNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeForParameterNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\OffsetAccessTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\TypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode;
use WPDev\Dependencies\PHPStan\PhpDocParser\Lexer\Lexer;
use WPDev\Dependencies\PHPStan\PhpDocParser\Parser\ConstExprParser;
use WPDev\Dependencies\PHPStan\PhpDocParser\Parser\ParserException;
use WPDev\Dependencies\PHPStan\PhpDocParser\Parser\TokenIterator;
use WPDev\Dependencies\PHPStan\PhpDocParser\Parser\TypeParser;
