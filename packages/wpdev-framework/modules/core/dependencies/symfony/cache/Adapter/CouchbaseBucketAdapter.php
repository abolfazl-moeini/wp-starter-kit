...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\WPDev\Dependencies\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \WPDev\Dependencies\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \WPDev\Dependencies\CouchbaseCluster($connectionString);
