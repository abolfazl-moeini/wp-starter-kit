 ...
 */
namespace WPDev\Dependencies\Symfony\Component\Cache\Adapter;

use WPDev\Dependencies\Doctrine\DBAL\ArrayParameterType;
use WPDev\Dependencies\Doctrine\DBAL\Configuration;
use WPDev\Dependencies\Doctrine\DBAL\Connection;
use WPDev\Dependencies\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use WPDev\Dependencies\Doctrine\DBAL\DriverManager;
use WPDev\Dependencies\Doctrine\DBAL\Exception as DBALException;
use WPDev\Dependencies\Doctrine\DBAL\Exception\TableNotFoundException;
use WPDev\Dependencies\Doctrine\DBAL\ParameterType;
use WPDev\Dependencies\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use WPDev\Dependencies\Doctrine\DBAL\Schema\Schema;
use WPDev\Dependencies\Doctrine\DBAL\Tools\DsnParser;
...
use WPDev\Dependencies\Symfony\Component\Cache\PruneableInterface;
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \WPDev\Dependencies\Doctrine\DBAL\Platforms\SQLServer2012Platform:
