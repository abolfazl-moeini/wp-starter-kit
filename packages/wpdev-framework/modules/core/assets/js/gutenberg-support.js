...
(function($) {
  ...
  $(document).ready(function() {
    ...
    const custom_gutenberg_preview_message = function(content) {
      ...
      content = content.replace(wp.i18n.__('Generating preview…'), wpdev_gutenberg.replacement_message);

      const img = '<img class="wpdev-logo" src="' + wpdev_gutenberg.logo + '"><p>';
    ...
    if (typeof wp === 'object' && typeof wp.hooks === 'object') {
       ...
       * Pass as a wp hook
       */
      wp.hooks.addFilter('editor.PostPreview.interstitialMarkup', 'wpdev/custom-preview-message', custom_gutenberg_preview_message);
