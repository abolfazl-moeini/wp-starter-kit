 ...
 *
 * @package WPDevFramework\Internal
 * @since 2.0.11
 */

namespace WPDevFramework\Internal;
...
class Memory_Trap {
	...
	public function memory_limit_error_handler($error) { // phpcs:ignore
		...
		$message = sprintf(__('Your server\'s PHP and WordPress memory limits are too low to perform this check. You might need to contact your host provider and ask the PHP memory limit in particular to be raised.', 'wpdev'));
