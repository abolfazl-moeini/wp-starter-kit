 ...
 *
 * Handles discount code compatibility back-ports to WPDev 1.X builds.
 *
 * @package WPDev
...
class Discount_Code_Compat {
	...
	public function check_update_coupon($null, $object_id, $meta_key, $meta_value, $prev_value) {
		 ...
		 */
		$migrated_discount_code = wpdev_get_discount_code($object_id);
		 ...
		 */
		$migrated_discount_code->update_meta('wpdev_' . $meta_key, maybe_serialize($meta_value));
