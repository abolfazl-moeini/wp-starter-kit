...
class Price_Variations extends Rule {
  ...
  public function check($value) : bool {
    ...
    foreach ($value as $price_variation) {
       ...
       * Validation Duration
       */
      $duration = wpdev_get_isset($price_variation, 'duration', false);
       ...
       * Validation Unit
       */
      $unit = wpdev_get_isset($price_variation, 'duration_unit', false);
       ...
       * Validation Amount
       */
      $amount = wpdev_get_isset($price_variation, 'amount', false);

      if ($amount) {

        $amount = wpdev_to_float($amount);
