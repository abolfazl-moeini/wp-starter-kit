...
use WPDevFramework\Models\Base_Model;
...
class Post_Base_Model extends Base_Model {
	 ...
	 * @var string
	 */
	protected $query_class = '\\WPDev\\Database\\Posts\\Post_Query';
	...
	public function save() {
		...
		if (!$this->status) {
			 ...
			 */
			$this->status = apply_filters('wpdev_post_default_status', 'draft', $this->type, $this);
