...
class Note {
	...
	public function attributes($data) {
		...
		$this->attributes['date_created'] = wpdev_get_current_time('mysql', true);
	...
	public function __get($name) {
		...
		return apply_filters("wpdev_note_get_{$name}", $value, $this);
	...
	public function __set($name, $value) {
		...
		$value = apply_filters("wpdev_note_set_{$name}", $value, $this);
	...
	public static function fields() {
		...
		$fields['author_id'] = array(
			'type'  => 'number',
			'title' => __('Author ID', 'wpdev'),
		);

		$fields['note_id'] = array(
			'type'  => 'text',
			'title' => __('Note ID', 'wpdev'),
		);
