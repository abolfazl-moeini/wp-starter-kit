...
class Country_SG extends Country {
	...
	public function get_name() {
		...
		return __('Singapore', 'wpdev-locations');
	...
	protected function states() {
		...
		return array(
			'01' => __('Central Singapore Community Development Council', 'wpdev-locations'),
			'02' => __('North East Community Development Council', 'wpdev-locations'),
			'03' => __('North West Community Development Council', 'wpdev-locations'),
			'04' => __('South East Community Development Council', 'wpdev-locations'),
			'05' => __('South West Community Development Council', 'wpdev-locations'),
		);
