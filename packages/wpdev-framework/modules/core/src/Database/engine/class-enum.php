<?php
/**
 * WPDev ENUM base class.
 *
 * @package WPDev
 * @subpackage WPDevFramework\Database\Engine
 * @since 2.0.0
 */
...
abstract class Enum
{
    ...
    public static function get_options() {
   		...
   		if (!isset(static::$options[$hook])) {
   			...
   			static::$options[$hook] = apply_filters("wpdev_available_{$hook}_options", $reflector->getConstants());
    ...
    public function get_label() {
   		...
   		$labels = apply_filters("wpdev_available_{$hook}_labels", $this->labels());
    ...
    public function get_classes() {
   		...
   		$classes = apply_filters("wpdev_available_{$hook}_classes", $this->classes());
    ...
    public function get_icon_classes() {
   		...
   		$classes = apply_filters("wpdev_available_{$hook}_icon_classes", $this->icon_classes());
    ...
    public static function to_array() {
   		...
   		$labels = apply_filters("wpdev_{$hook}_to_array", $instance->labels());
