      ...
      <div id="general" data-type="heading" class="wpdev-bg-gray-100 wpdev--mt-1 wpdev--mx-3 wpdev-p-4 wpdev-border-solid wpdev-border-b wpdev-border-l-0 wpdev-border-r-0 wpdev-border-t-0 wpdev-border-gray-300">
        <h3 class="wpdev-m-0 wpdev-p-0 wpdev-uppercase wpdev-text-gray-600 wpdev-text-sm wpdev-tracking-wide">General Options</h3>
        <p class="wpdev-m-0 wpdev-p-0 wpdev-text-gray-600">Here we define some of the fundamental settings of the plugin.</p>
      </div>
      ...
      <table class="form-table">
       ...
       <div id="general" data-type="heading" class="wpdev-bg-gray-100 wpdev--mt-1 wpdev--mx-3 wpdev-p-4 wpdev-border-solid wpdev-border-b wpdev-border-l-0 wpdev-border-r-0 wpdev-border-t wpdev-border-gray-300">
        <h3 class="wpdev-m-0 wpdev-p-0 wpdev-uppercase wpdev-text-gray-600 wpdev-text-sm wpdev-tracking-wide">Currency Options</h3>
        <p class="wpdev-m-0 wpdev-p-0 wpdev-text-gray-600">The following options affect how prices are displayed on the frontend, the backend and in reports.</p>
      </div>
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" id="currency_symbol-desc">
                Select the currency symbol to be used in WPDev
              </p>
          ...
          <tr id="multiselect-limits_and_quotas">
            ...
            <td>
              ...
              <div class="row ">
                ...
                <div class="wpdev-col-sm-4" style="margin-bottom: 2px;">
              ...
              <button type="button" data-select-all="multiselect-limits_and_quotas" class="button wpdev-select-all">Check /
                Uncheck All</button>
      ...
      <div id="error_reporting" data-type="heading">
        ...
        <p>Help us make WPDev better by automatically reporting fatal errors and warnings so we can fix them as soon
          as possible.</p>
      </div>
      ...
      <table class="form-table">
        <tbody>
          ...
          <tr>
            <th scope="row"><label for="enable_error_reporting">Send Error Data to WPDev Developers</label> </th>
            <td>

              <label for="enable_error_reporting">
                <input name="enable_error_reporting" type="checkbox" id="enable_error_reporting" value="1">
                Send Error Data to WPDev Developers </label>

              <p class="description" id="enable_error_reporting-desc">
                With this option enabled, every time your installation runs into an error related to WPDev, that
          ...
          <tr>
            ...
            <td>
              ...
              <p class="description" id="uninstall_wipe_tables-desc">
                Remove all saved data for WPDev when the plugin is uninstalled.
              </p>
      ...
      <p class="submit">
        ...
        <input type="hidden" id="_wpnonce" name="_wpnonce" value="59c475b6c4"><input type="hidden"
          name="_wp_http_referer" value="/wp-admin/network/admin.php?page=wpdev"> <input type="hidden"
          name="wpdev_action" value="save_settings">
      </p>
