 ...
 * @since 2.0.7
 */
$wpdev_mercator = defined('WP_PLUGIN_DIR')
	? WP_PLUGIN_DIR . '/wpdev-examples/domains/src/mercator/mercator.php'
	: WP_CONTENT_DIR . '/plugins/wpdev-examples/domains/src/mercator/mercator.php';

if ( file_exists( $wpdev_mercator ) ) {
