(function(blocks, element, components, wpdev_blocks, _) {
  ...
  _.each(wpdev_blocks, function(block, index) {
    ...
    registerBlockType(block.id, {
      ...
      edit(props) {
        ...
        return [
          ...
          wpdev_fields_to_block_options(block.fields, props),
        ];
  ...
  function wpdev_fields_to_block_options(fields, props) {
    ...
    _.each(fields, function(field, field_slug) {
      ...
      const component = wpdev_get_field_component(field.type, field);
      ...
      if (should_display) {
        ...
        gt_fields.push(el(component, {
          ...
          options: wpdev_format_options(field.options),
          min: field.min,
          max: field.max,
          onChange(value) {
    ...
    return el(InspectorControls, { key: 'wpdev' }, gt_panels);

  } // end wpdev_fields_to_block_options;

  function wpdev_format_options(options) {
  ...
  function wpdev_get_field_component(field_type, field) {
