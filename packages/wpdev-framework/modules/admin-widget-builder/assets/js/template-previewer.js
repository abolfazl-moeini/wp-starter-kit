...
window.addEventListener("beforeunload", () => {
  var _a;
  return (_a = window.top) == null ? void 0 : _a.postMessage("wpdev_preview_changed", "*");
});
CreateCookie("wpdev_template", "");
const isIOS = () => {
  var _a;
...
document.addEventListener("DOMContentLoaded", () => {
  var _a;
  ListenToCookieChange("wpdev_selected_products", () => document.location.reload());
  ...
  elements.forEach((element) => element.addEventListener("click", (event) => {
    ...
    CreateCookie("wpdev_template", value);
    window.close();
  }));
  iframe == null ? void 0 : iframe.addEventListener("load", () => {
    ...
    if (isIOS()) {
      ...
      body == null ? void 0 : body.classList.add("wpdev-fix-safari-preview");
